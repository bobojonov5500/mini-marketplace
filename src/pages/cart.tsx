...
const CartPage = () => {
    const [products, setProducts] = useState<DataTypes[]>([]);
            ...
            {products.length > 0 ? (
                <section className="bg-white py-8 antialiased  md:py-16">
                    <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                        <h2 className="text-xl font-semibold text-center  md:mt-0 sm:text-2xl">
                            Shopping Cart
                        </h2>
                                    ...
                                    <div key={product.id} className="space-y-6">
                                        <div className="rounded-lg  p-4  bg-gray-100  md:p-6">
                                            <div className="space-y-4  md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                                <div className=" flex items-center mx-auto max-w-[220px] md:w-[150px]  p-2 hover:scale-110 transition-transform duration-300 ease-in-out  h-60">
                                                    <img className="rounded-lg   object-contain duration-700 ease-in-out" src={product.image} alt="image" />
                                                </div>
                ...
                <div className="h-screen flex items-center gap-2 justify-center text-[30px]">
                    cart is empty
